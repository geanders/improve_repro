...
The idea of *control* is to allow for safe changes and updates to this version
...
[@irving2011astonishments], it's much more efficient to use a computer program
to handle this tracking and coordinate contributions from multiple people.

Software for this purpose---*version control software*---first developed for
...
are good at and humans are not." 
...
called a *commit*, and it provides a record of which lines in each file changed
...
tool called *diff*. This tool, developed early in the history of Unix at AT&T
[@raymond2003art], is a solid and well-tested tool that does the simple but
...
for *annotation* of the developing and editing process [@raymondunderstanding].
Each commit requires you to enter a *commit message* describing why the changes
...
version as it was when a certain commit was made, providing *reversability*
...
from the command line [@perez2016ten]. It also plays well with RStudio, making
...
become everyone's go-to for version control." 
...
multiple experiments [@giles2012digital; @butler2005electronic;
@perkel2011coding].
...
needs [@giles2012digital]. Some early adapters were pharmaceutical industrial
...
yet to happen---but more and more scientists are taking the plunge." 
...
[@raymond2003art]. However, both git and GitHub can bring dramatic gains to
