...
[@hermans2015enron]. They found that passing Excel files through email
...
accessible to all team members [@hermans2015enron], which meant that team
...
via email." [@hermans2015enron] The same process for collaboration is often used
...
servers, websites, and databases." [@edwards2011science]
...
@perkel2011coding]. Further, physical lab notebooks can be inefficient to 
...
working on [@raymondunderstanding; @target2018version]. Very early on, under
what is called a *centralized* framework, this was kept on one
...
[@raymondunderstanding]. This idea allowed for the development of other useful
features and styles of working, including *branching* to try out new ideas that
you're not sure you'll ultimately want to go with and *forking*, a key tool used
