...
- [Module 1: Separating data recording and analysis](#module1)
- [Module 2: Principles and power of structured data formats](#module2)
- [Module 3: The 'tidy' data format](#module3)
- [Module 4: Designing templates for "tidy" data collection](#module4)
- [Module 5: Example: Creating a template for "tidy" data collection](#module5)
- [Module 6: Power of using a single structured 'Project' directory for storing and tracking research project files](#module6)
- [Module 7: Creating 'Project' templates](#module7)
- [Module 8: Example: Creating a 'Project' template](#module8)
- [Module 9: Harnessing version control for transparent data recording](#module9)
- [Module 10: Enhance the reproducibility of collaborative research with version control platforms](#module10)
- [Module 11: Using git and GitLab to implement version control](#module11)
