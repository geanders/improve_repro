...
- [Separating data recording and analysis](https://geanders.github.io/improve_repro/2.1-separating-data-recording-and-analysis.html#separating-data-recording-and-analysis)
- [Principles and power of structured data formats](https://geanders.github.io/improve_repro/2.2-principles-and-power-of-structured-data-formats.html#principles-and-power-of-structured-data-formats)
- [The 'tidy' data format](https://geanders.github.io/improve_repro/2.3-the-tidy-data-format.html#the-tidy-data-format)
- [Designing templates for "tidy" data collection](https://geanders.github.io/improve_repro/2.4-designing-templates-for-tidy-data-collection.html#designing-templates-for-tidy-data-collection)
- [Example: Creating a template for "tidy" data collection](https://geanders.github.io/improve_repro/2.5-example-creating-a-template-for-tidy-data-collection.html#example-creating-a-template-for-tidy-data-collection)
- [Power of using a single structured 'Project' directory for storing and tracking research project files](https://geanders.github.io/improve_repro/2.6-power-of-using-a-single-structured-project-directory-for-storing-and-tracking-research-project-files.html#power-of-using-a-single-structured-project-directory-for-storing-and-tracking-research-project-files)
- [Creating 'Project' templates](https://geanders.github.io/improve_repro/2.8-example-creating-a-project-template.html#example-creating-a-project-template)
- [Example: Creating a 'Project' template](https://geanders.github.io/improve_repro/2.8-example-creating-a-project-template.html#example-creating-a-project-template)
- [Harnessing version control for transparent data recording](https://geanders.github.io/improve_repro/2.9-harnessing-version-control-for-transparent-data-recording.html#harnessing-version-control-for-transparent-data-recording)
- [Enhance the reproducibility of collaborative research with version control platforms](https://geanders.github.io/improve_repro/2.10-enhance-the-reproducibility-of-collaborative-research-with-version-control-platforms.html#enhance-the-reproducibility-of-collaborative-research-with-version-control-platforms)
- [Using git and GitLab to implement version control](https://geanders.github.io/improve_repro/2.11-using-git-and-gitlab-to-implement-version-control.html#using-git-and-gitlab-to-implement-version-control)
