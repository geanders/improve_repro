...
biomedical researchers at the University of Washington [@anderson2007issues],
...
general-purpose software in their research [@altarawneh2017pilot]. A working
group on bioinformatics and data-intensive science similarly found spreadsheets
were the most common tool used across attendees [@barga2011bioinformatics].
...
[@campbell2007number], this all-in-one practice impedes the transparency and
...
previously required programming expertise [@levy1984spreadsheet]. With
...
rather than just the *first* tool to use to explore a solution. These tools are
...
@broman2018data]. In this case, data processing and analysis is implemented
...
downstream calculations and analyses [@levy1984spreadsheet]. Since early in
their development, spreadsheet programs have also included *macros*, "a single
...
[@myneni2010organization]. In fact, one study of
...
changed a value, when it was changed, or why [@altarawneh2017pilot]. Further,
...
files) [@campbell2007number]. However, this file format may be hard to open in
the future, as software changes and evolves [@michener2015ten]; by comparison,
...
separated from the data [@creeth1985microcomputer]. Calculations done
...
were released during legal proceedings [@hermans2015enron]. They specifically
...
overall plan [@altarawneh2017pilot]. As a result, research spreadsheets are
often not designed to follow a common structure for the research field or for
the laboratory group [@anderson2007issues].
...
[@myneni2010organization]. This is particularly common if the spreadsheet
includes complex macros or a complicated structure in the analysis pipeline
[@creeth1985microcomputer]. This practice creates a heavy dependence on the
...
spreadsheets [@hermans2016spreadsheets]. For example, one study of 50
...
scenes [@birch2018future]. This makes it hard to get a clear and complete
...
### Better software tools are available
...
Excel, the number of days since January 1, 1900 [@willekens2013chronological]).
...
lost for further analysis [@zeeberg2004mistaken].
...
were composed of digits and the letter "E" [@zeeberg2004mistaken;
@welsh2017escape]. These were assumed to be expressing a number using scientific
...
[@birch2018future]. Further, while spreadsheet programs continue to expand in
their capacity for data, for very large datasets they continue to face limits
that may be reached in practical applications [@birch2018future]---until
