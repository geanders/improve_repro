...
\tightlist
\item
  \href{https://geanders.github.io/improve_repro/2.1-separating-data-recording-and-analysis.html\#separating-data-recording-and-analysis}{Separating data recording and analysis}
\item
  \href{https://geanders.github.io/improve_repro/2.2-principles-and-power-of-structured-data-formats.html\#principles-and-power-of-structured-data-formats}{Principles and power of structured data formats}
\item
  \href{https://geanders.github.io/improve_repro/2.3-the-tidy-data-format.html\#the-tidy-data-format}{The `tidy' data format}
\item
  \href{https://geanders.github.io/improve_repro/2.4-designing-templates-for-tidy-data-collection.html\#designing-templates-for-tidy-data-collection}{Designing templates for ``tidy'' data collection}
\item
  \href{https://geanders.github.io/improve_repro/2.5-example-creating-a-template-for-tidy-data-collection.html\#example-creating-a-template-for-tidy-data-collection}{Example: Creating a template for ``tidy'' data collection}
\item
  \href{https://geanders.github.io/improve_repro/2.6-power-of-using-a-single-structured-project-directory-for-storing-and-tracking-research-project-files.html\#power-of-using-a-single-structured-project-directory-for-storing-and-tracking-research-project-files}{Power of using a single structured `Project' directory for storing and tracking research project files}
\item
  \href{https://geanders.github.io/improve_repro/2.8-example-creating-a-project-template.html\#example-creating-a-project-template}{Creating `Project' templates}
\item
  \href{https://geanders.github.io/improve_repro/2.8-example-creating-a-project-template.html\#example-creating-a-project-template}{Example: Creating a `Project' template}
\item
  \href{https://geanders.github.io/improve_repro/2.9-harnessing-version-control-for-transparent-data-recording.html\#harnessing-version-control-for-transparent-data-recording}{Harnessing version control for transparent data recording}
\item
  \href{https://geanders.github.io/improve_repro/2.10-enhance-the-reproducibility-of-collaborative-research-with-version-control-platforms.html\#enhance-the-reproducibility-of-collaborative-research-with-version-control-platforms}{Enhance the reproducibility of collaborative research with version control platforms}
\item
  \href{https://geanders.github.io/improve_repro/2.11-using-git-and-gitlab-to-implement-version-control.html\#using-git-and-gitlab-to-implement-version-control}{Using git and GitLab to implement version control}
\end{itemize}
...
appropriate throughout all steps of pre-processing, analysis, and visualization
...
The data from genomic and other 'omic experiments
...
There's a second reason why dataframe structures don't always work for
data from biological experiments. The traditional dataframe structure in R is
built after reading all the data in R's local memory {[}?{]}. Many biological
experiments now create data that is much too large to read into memory for
R in a reasonable way. More complex data structures can allow more sophisticated
ways to handle massive data, and so they are often necessary when working with
massive biological datasets, particularly early in pre-processing, before the
data can be summarized in an efficient way.
...
This approach can be done by working with the data while it is what's called
\emph{on disc}---that is, most of the data is left in longer-term forms of memory,
like \ldots, and smaller pieces of it are read into R and processed at any given time.
\ldots{}
...
\includegraphics{improve_repro_files/figure-latex/unnamed-chunk-11-1}
...
\includegraphics{improve_repro_files/figure-latex/unnamed-chunk-14-1}
