...
In module 20, we'll walk through an example of creating a data pre-processing
...
clearly defined steps, as well as explanations for each step. They illustrate
...
Finally, in module 20, we'll walk through a full example of writing a data pre-processing
...
document is, as well as some of the advantages of using this format to
...
of content (Figure \ref{fig:xcmsexample}).
...
else, executing that code and adding in results in the right place. Finally,
...
levels (e.g., to mark off sections and subsections), block quotes, horizontal
...
the mechanics of how all knitted documents work, and then in the next module
...
concert with LaTeX. It allows you to save bibliographical information in a plain
...
You will follow a special convention when you cite a paper: you'll use the
...
With full paper details included at the end of the document, in a reference
section.
...
file, with the bibliographical information for each source you plan to cite (see module 3.19).
...
the standard method for RMarkdown (module 19). Figure \ref{fig:protocolcode}
...
of ``knitted'' documents (modules 18 and 19), you can combine the executable code
...
using a tool like RMarkdown (modules 18 and 19), you can ensure that the protocol is
...
for example a comma-separated delimited file (modules 4 and 5). Each time you render
...
available---include these using BibTeX (module 19). By doing this, you will make it much
...
\hypertarget{applied-exercise-8}{%
\section{Applied exercise}\label{applied-exercise-8}}
