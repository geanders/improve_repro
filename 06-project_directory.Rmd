...
## Advantages of organizing project files 
...
wasted in frenzied hunting for missing information." [@baker2016quality] 
...
Now that we've explained *why* to organize project files, let's talk about
*how* you can do that. We'll cover higher-level principles in this
...
[@vuorre2021sharing]. In later modules in this book (modules \@ref(module9)--\@ref(module11)), we will
...
in detail what you did and why." [@noble2009quick] Another notes, "The key
...
## What is a project directory template?
