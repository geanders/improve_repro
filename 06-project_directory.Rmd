...
in that treatment group, which is recorded as shown in Figure \@ref(fig:mouseweights). 
...
in that mouse. ... Figure \@ref(fig:bacterialload) shows an example of how the data on 
