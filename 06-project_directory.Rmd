...
```{r metadata, fig.fullwidth = TRUE, echo = FALSE, out.width = "\\textwidth", fig.cap = "Example of recording metadata on a study in the set of example studies for this module."}
...
in that mouse. ... Figure [x] shows an example of how the data on 
