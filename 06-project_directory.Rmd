...
*Mycobacterium tuberculosis*. After a period of time, the mice were sacrificed
...
## Details of the data from the set of example studies
...
with a numeric ID (e.g., a 0 in the `rx_group` column indicates one of the
...
[Visual---project directory as a *mise en place* for cooking---everything you 
...
are consistently named." [@buffalo2015bioinformatics]
...
reproduce." [@buffalo2015bioinformatics]
...
less error prone.)" [@buffalo2015bioinformatics]
...
more contain erroneous results because of a file naming issue." [@buffalo2015bioinformatics]
