...
- [Module 3.7: Complex data types in R and Bioconductor](#module16)
- [Module 3.8: Example: Converting from complex to 'tidy' data formats](#module17)
- [Module 3.9: Introduction to reproducible data pre-processing protocols](#module18)
- [Module 3.10: RMarkdown for creating reproducible data pre-processing protocols](#module19)
- [Module 3.11: Example: Creating a reproducible data pre-processing protocol](#module20)
