...
Protocols are similarly used to medical procedures and tests, as well as for 
clinical trials. In all cases, they help to define in detail the steps of the
procedure, so they can be done in a way that is comparable from one case to the
next and with high precision. 
...
"checked" every time you render the document. In the last part of this module,
we will give an overview of how these knitted documents work, and then in the
next module, we'll show how you can make them in the free RStudio software. In
module 20, we'll walk through a full example of writing a data pre-processing
...
In the next module, we'll look at how you 
can leverage these two technique using RMarkdown documents.
