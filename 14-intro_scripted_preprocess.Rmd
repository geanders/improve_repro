# Introduction to scripted data pre-processing in R {#module14} 
...
## How code scripts improve reproducibility of pre-processing
...
can do so with the name `my_data`, which now stores the data from that file. 
