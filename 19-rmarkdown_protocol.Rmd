...
R has a special format for creating knitted documents called **Rmarkdown**.  As
...
Markdown notation `## R Markdown` in the original file. The header is formatted
...
Markdown syntax `**Knit**`, and a clickable link specified through the syntax
`<http://rmarkdown.rstudio.com>`. At the beginning of the original document, you
...
presented. These specifications are called **chunk options**, and you specify
them in the special character combination where you mark the start of executable
code.

These chunk options include `eval`, which specifies whether to evaluate the code
