...
Further, coding requires you to be precise in this language. As Kernighan
...
Script-based approaches encourage the user to learn how the underlying process
...
mistakes in by-hand processing [@gibb2014reproducibility]. As Bruce Gibb 
writes in an article about reproducibility: 
