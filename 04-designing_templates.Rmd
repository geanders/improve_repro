...
```{r arrangingcolumns, fig.fullwidth = FALSE, echo = FALSE, out.width = "\\textwidth", fig.cap = "Examples of special characters and formatting in the example template that could cause problems later in a data analysis pipeline."}
knitr::include_graphics("figures/arranging_columns.png")
```

Conversely ... [information that R doesn't have a function to parse.]
