...
In the last few module, we discussed why the tidyverse approach is an
excellent way to work with data in R. Unfortunately, though, there are 
cases where you will need to use a different approach. 
...
This and the following few modules aim to help you navigate this process. 
...
There are a few characteristics that can make data unsuitable for a tidyverse
approach. Biomedical data often have these characteristics. 
...
store data in more complex data structures.
...
Other datasets may not fit well within the two-dimensional, non-ragged structure
...
naturally into a dataframe structure.
