...
[@ben2014estimation]. These data are originally from an experiment in one of our
authors' laboratory and are also available as example data for an R package
called `bactcountr`, currently under development at
