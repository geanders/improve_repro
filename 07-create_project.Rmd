...
As you design, it's useful to keep in mind the resources that you have available
[@osann2020design]. In this case, the key resources are the file directory and
...
the Unix file directory system and file designs.

### Designing a project template 

A key part of the design process is to prototype and then test [@osann2020design].
...
once you've tried it and identified where it works and where it doesn't.
...
The step of creating a blueprint for your project directory template is a
...
works well for your research group. 
...
One of the key early steps in the design process is to "observe"
[@osann2020design]. This lets you get a firmer idea of what problem you're 
trying to solve and what is needed to solve this. Another early step is 
to "synthesize" based on what you've observed [@osann2020design]. This 
...
design is successful in addressing the problem you were trying to solve. 
...
data collection templates is described in detail in Module [x].
...
easy-to-read format like Word or PDF.
...
based on what you find out in practice [@osann2020design].

A prototype doesn't have to be fully refined, just built out enough that the 
users can test it out [@osann2020design].
...
It involves creating a basic file
...
[Designing report scripts and leveraging filenames in those scripts]
...
- Add `sessionInfo` at the end of report templates 
