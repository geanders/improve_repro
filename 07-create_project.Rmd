...
useful to start by defining the problem [@osann2020design]. What are you aiming
...
based on our own experiences and the advice of others [@marwick2018packaging; @bertin2021creating]: 
...
> "In many cases it can be useful to give the analysis scripts ascending names, for example 001-load.R, 002-clean.R etc. This kind of file-naming helps with organisation" [@marwick2018packaging]

> "2. a. Files are clearly named, preferably in a way where the order in which they should be run is clear.
...
3. a. No absolute paths, or paths leading to locations outside of a project's directory, are used in code—only portable (relative) paths." [@bertin2021creating]
...
Adam Savage, the host of the *Mythbusters* television show who we introduced in 
...
[@vuorre2021sharing; @prodigenr]. Others have suggested naming the raw data
...
that you used to create the intermediate data from those raw data [@prodigenr].
...
computer to store the full set of raw data [@marwick2018packaging]. It
...
[@blischak2019creating]. These two subdirectories could be named "analysis" and
"output", respectively [@blischak2019creating]. Another article recommends
using separate subdirectories for different types of report outputs, for 
example "posters", "manuscript", and "slides" [@vuorre2021sharing].
...
**Meta-documentation subdirectories or files**
