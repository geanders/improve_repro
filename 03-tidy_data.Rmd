...
tools more focused on other steps, like data analysis [@wickham2014tidy]. The word
...
could be saved in a file in a way that is either "tidy" (in the sense of [@wickham2014tidy]) or untidy, depending only on how the data are organized across columns
and rows.
...
almost every way imaginable." [@wickhame2014tidy]
