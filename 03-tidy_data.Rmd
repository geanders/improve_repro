...
defined in a 2014 paper [@wickham2014tidy]. 
...
found by a powerful collection of tools called the *tidyverse*.
...
[@wickham2014tidy]. To figure out if your data format follows this rule, it's
important to determine the *unit of observation* of that data, which is the unit
at which you take measurements [@sedgwick2014unit]. This idea is different than
the *unit of analysis*, which is the unit that you're focusing on in your study
hypotheses and conclusions (this is sometimes also called the "sampling unit" or
"unit of investigation") [@altman1997units]. In some cases, these two might be
equivalent (the same unit is both the unit of observation and the unit of
measurement), but often they are not [@sedgwick2014unit]. Sedgwick notes:
...
We often refer to this change as *pivoting* the dataframe from a *wider* 
...
*measured variable*, since its value is determined through the experiment)
[@wickham2014tidy].
...
@peng2018teaching]. This is because the developers who have created the
tidyverse tools have taken a lot of effort to try to make sure that they have a
clear and consistent *user interface* [@wickham2017tidy; @bryan2017data]. 
...
When you download R, you get what's called *base R*. This includes the main code
...
onto R through what are called *packages* (sometimes also referred to as
*extensions* or *libraries*). These are kind of like "booster packs" that add on
