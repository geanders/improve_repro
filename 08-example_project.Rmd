...
can be found at https://github.com/geanders/example_for_improve_repro, where you
...
must be done under observation [@barry2009new]. If the patient has a
...
```{r metadata, echo = FALSE, out.width = "100%", fig.cap = "Example of recording metadata for a study in the set of example studies for this module."}
...
```{r treatmentdetails, echo = FALSE, out.width = "100%", fig.cap = "Example of recording treatment details for a study in the set of example studies for this module."}
...
```{r mouseweight, echo = FALSE, out.width = "100%", fig.cap = "Example of recording weekly weights of mice in each treatment group for the example set of studies."}
...
```{r bacterialload, echo = FALSE, out.width = "100%", fig.cap = "Example of recording the bacterial load in the lungs of each mouse at the end of treatment for the example set of studies."}
...
```{r templatedirectorymod8, echo = FALSE, out.width = "100%", fig.cap = "A research group can create a file directory that will serve as a template for all the experiments of a certain type in your laboratory. The template can include templates of files for data recording and for generating reports. To start recording data for a new experiment, a researcher can copy and rename this template directory."}
...
```{r projecttemplatecomplexmod8, fig.cap = "Example of a more complex project directory structure that could be created, with directories added to store data collected through flow cytometry and single cell RNA sequencing.", out.width = "100%"}
...
```{r replacingplaceholdertreatment2, echo = FALSE, out.width = "100%", fig.cap = "The template includes a file with experiment metadata, with a sheet for recording the details of each treatment. A user can open this file and replace the placeholder values (in red) with real values for the treatments in the experiment. By changing the text color to black, the user can have a visual confirmation that the placeholder data have been replaced with real study data."}
...
```{r studytable, echo = FALSE, out.width = "100%", fig.cap = "Example of one element of the preliminary report generated for each study in the set of example studies for this module. The first page provides tables with metadata about the study and details about each treatment that was tested."}
...
```{r mouseweightsplot, echo = FALSE, out.width = "100%", fig.cap = "Example of one element of the preliminary report generated for each study in the set of example studies for this module. The second page provides a plot of how the weights of mice in each treatment changed over the course of treatment."}
...
```{r bactcompare, echo = FALSE, out.width = "100%", fig.cap = "Example of one element of the preliminary report generated for each study in the set of example studies for this module. The third page provides results on how bacterial load in the lungs compares among treatments at the end of the treatment period."}
