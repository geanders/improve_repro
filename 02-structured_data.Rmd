...
additional cleaning before it can be input into data analysis [@broman2018data].
...
reducing the probability of errors in analysis [@ellis2018share]. Data that is
...
[@broman2018data]. Further, by using a consistent structured format across many
...
[@broman2018data]. However, many biomedical researchers are unaware of this
simple yet powerful strategy in data recording and how it can improve the
efficiency and effectiveness of collaborations [@ellis2018share]. In this
...
## Elements of a data recording standard
...
*ontologies*, *minimum information*, and *file formats* [@ghosh2011software].

### Ontology standards
 
The first facet of a data standard is called an *ontology* (sometimes called a
*terminology* [@sansone2012toward]). An ontology helps define a vocabulary that
...
Another part of a data standard is *minimum information*. Within a data
...
*somewhere*, and using a consistent vocabulary---it doesn't specify where those
...
## Defining data recording standards for data recorded "by hand"
...
- Find an example from your research field of *minimum information* or
*minimum reporting guidelines*. What do you see as the advantages or disadvantages
